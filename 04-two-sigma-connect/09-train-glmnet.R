...
resample <- resample(learner = learner, 
                     ...
                     measures = logloss, 
                     keep.pred = FALSE)
# [Resample] Aggr. Result: logloss.test.mean=0.595
...
write_csv(predictions, "./04-two-sigma-connect/output/glmnet-01.csv")
...
write_csv(predictions_df, "./04-two-sigma-connect/output/glmnet-01-meta.csv")