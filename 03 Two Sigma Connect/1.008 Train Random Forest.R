...
write_csv(predictions, "./Two Sigma Connect/Output/Base Models/ranger_01.csv")
...
write_csv(predictions_df, "./Two Sigma Connect/Output/Meta Features/ranger_01_meta.csv")