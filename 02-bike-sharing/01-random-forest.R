...
# 2. Load data. 
train <- read_csv("./02-bike-sharing/data/train.csv") 
test <- read_csv("./02-bike-sharing/data/test.csv") 
...
write.csv(submission, "./02-bike-sharing/outut/01-random-forest.csv", row.names = FALSE)
